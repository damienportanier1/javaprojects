...
public class LabtwoApp{
	...
	//Object
	Labtwo n;
		n=new Labtwo (); // cinemaBis is a name we give to the copyobject we created (new) which is base on NameInstantiableFile
	//Input
	...
	JOptionPane.showMessageDialog(null,"The number is "+msg+".");
	}
}
